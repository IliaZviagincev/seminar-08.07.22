...
else
{
    ...
    else
    {
        ...
        {
            //проверяем равенство первого и второго числа и при совпадении выясняем разницу с третьим числом
            if (num1 == num2)
            {
                int a = num1;
                int b = num3;
            ...
            //проверяем равенство первого и третьего числа и при совпадении выясняем разницу со вторым числом
            if (num1 == num3)
            {
                int a = num1;
                int b = num2;
